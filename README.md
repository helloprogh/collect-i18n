...
当前版本为 `v0.4.0`。工具不会为了提高覆盖率向目标项目添加测试页面、预期词条、假路由或强制显示代码。
...
从 [GitHub Releases](https://github.com/helloprogh/collect-i18n/releases/latest) 下载 `collect-i18n-skill-v0.4.0.zip`，解压后应形成：

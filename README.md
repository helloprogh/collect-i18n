...
当前版本为 `v0.3.18`。工具不会为了提高覆盖率向目标项目添加测试页面、预期词条、假路由或强制显示代码。
...
从 [GitHub Releases](https://github.com/helloprogh/collect-i18n/releases/latest) 下载 `collect-i18n-skill-v0.3.18.zip`，解压后应形成：
...
- [v0.3.18 发布说明](docs/release-notes-v0.3.18.md)
- [v0.3.17 发布说明](docs/release-notes-v0.3.17.md)
- [v0.3.16 发布说明](docs/release-notes-v0.3.16.md)
- [v0.3.15 发布说明](docs/release-notes-v0.3.15.md)
